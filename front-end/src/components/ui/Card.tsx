...
export function Card({ children, className = '', variant = 'light' }: CardProps) {
  ...
  const variants = {
    light: 'bg-white dark:bg-[#161920] text-ink dark:text-white border-border dark:border-white/10 shadow-md shadow-black/5 dark:shadow-none',
    dark: 'bg-[#F5F3FF] dark:bg-[#0b0d12] text-ink dark:text-white border-purple-200 dark:border-white/5 shadow-lg shadow-purple-200/50 dark:shadow-black/25',
