...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center gap-3 p-2 bg-surface-raised border border-border/80 rounded-2xl shadow-sm mb-6 animate-fade-in font-sans">
      ...
      <div className="flex-1 min-w-0 flex items-center rounded-xl border border-border/80 bg-surface focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 overflow-hidden">
        <span className="pl-3.5 pr-1 flex items-center">
          <svg
        ...
        <input
          ...
          className="flex-1 py-2 pr-4 text-sm bg-transparent border-0 focus:ring-0 placeholder:text-ink-muted/60 focus:outline-none text-ink"
        />
      </div>
